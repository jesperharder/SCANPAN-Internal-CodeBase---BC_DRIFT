...
permissionset 50000 GeneratedPermission
{
    ...
    Permissions = tabledata "Address List" = RIMD,
        ...
        table "Prod. Dashboard User Pref." = X,
        ...
        codeunit "Prod. Dashboard Chart Mgt." = X,
        codeunit "Prod. Dashboard Data Mgt." = X,
        codeunit "Prod. Dashboard Drilldown Mgt." = X,
        codeunit "Prod. Dashboard Pref. Mgt." = X,
        ...
        page ScanpanSetup = X,
        // BC18-->BC25  page SearchAndReplace = X,
        page TestPage = X,
