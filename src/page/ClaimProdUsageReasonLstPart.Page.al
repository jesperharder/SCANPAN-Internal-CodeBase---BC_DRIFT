    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field(ProductUsageDescription; Rec.ProductUsageDescription) { ApplicationArea = All; }
                field(ReturnReasonCode; Rec.ReturnReasonCode) { ApplicationArea = All; }
                field(ReturnReasonDescription; Rec.ReturnReasonDescription) { ApplicationArea = All; }
                field(Sorting; Rec.Sorting) { ApplicationArea = All; }
